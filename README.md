...
### 🧠 ArchitectIQ– AI-Driven System Design Assistant

* Built an LLM-powered system that generates scalable architectures via intelligent requirement analysis
*  Integrated Pinecone-based RAG and interactive UI for real-time system design visualization

### 🤖 MedIQ – AI Personal Health Intelligence Platform

* Developed **scalable SaaS platform** for AI-driven health analysis
* Implemented **secure pipelines + real-time chat system**

### 💻 PrepMaster – AI Interview Preparation Platform

* Built **MERN-based platform** for coding + AI mock interviews
* Added **NLP-based feedback & performance analytics**

### 📊 DevPulse – Real-Time Website Monitoring Tool

* Developed system for **uptime, latency & performance tracking**
* Designed **automated health checks & analytics dashboard**
